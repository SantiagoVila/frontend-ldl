...
import api from '../api/api'; // Asegúrate de que este import esté aquí
...
function AdminLigasPage() {
    ...
    // --- FUNCIÓN PARA CARGAR LAS LIGAS EXISTENTES ---
    ...
    // --- HOOK DE EFECTO ---
    // Llama a fetchLigas() una vez cuando el componente se monta.
    useEffect(() => {
        fetchLigas();
    }, [token]);
    ...
    const handleCrearLiga = async (e) => {
        ...
        try {
            ...
            // Añade la nueva liga a la lista sin tener que recargar todo
    ...
    // Clases de Tailwind para reutilizar
